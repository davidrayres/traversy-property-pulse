    ...
    <>
      <section className='px-4 py-6'>
        <div className='container-xl lg:container m-auto'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>{recentProperties.length === 0 ? <p>No Properties Found</p> : recentProperties.map(property => <PropertyCard key={property._id} property={property} />)}</div>
        </div>
      </section>
